...
module.exports = function (/* ctx */) {
  return {
    ...
    build: {
      ...
      env: envparser(), // available values: 'hash', 'history'
    ...
    devServer: {
      ...
      proxy: {
        ...
        '/serverapi': {
          target: 'https://devgroceryapi.spericorn.com',
          changeOrigin: true,
          pathRewrite: {
            '^/serverapi': ''
          }
    ...
    pwa: {
      ...
      manifest: {
        name: `In App Machine Test`,
        short_name: `In App Machine Test`,
        description: `In App Machine Test`,
        display: 'standalone',
